...
const Carousel = () => {
  ...
  onClick={() => window.open('/HackathonApril-Report.pdf', '_blank')}
  className="shine-effect bg-[#007F40] cursor-pointer hover:bg-green-700 group flex items-center justify-center text-center hover:px-14 text-white font-bold py-3 px-8 rounded-sm text-base lg:text-lg transition-all duration-300 relative overflow-hidden"
          >
   PAST HACK-A-THON REPORT
