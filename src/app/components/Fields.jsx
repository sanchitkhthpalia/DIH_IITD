...
const ChallengesTable = () => {
  ...
  // const downloadFile = () => {
  //   const fileUrl = '/HackathonProblemStatement.pdf'; // Ensure the file is inside the public folder
  //   const anchor = document.createElement('a');
  //   anchor.href = fileUrl;
  //   anchor.download = 'HackathonProblemStatement.pdf'; // Set the downloaded file's name
  ...
  return (
    ...
    >
      <h2 className="text-4xl sm:text-4xl lg:text-5xl font-bold mb-8 md:mb-16 lg:mb-20 text-center">
        HACK-A-THON PROBLEM STATEMENTS
      </h2>
      <p className="space-y-6 max-w-6xl mx-auto mb-10 text-lg sm:text-lg lg:text-xl leading-relaxed text-center">
        This document outlines the problem statements for our upcoming Hack-a-thon. Participants are encouraged to explore innovative solutions across various domains, addressing specific challenges faced by the Army, technology sectors, and women&apos;s representation in these fields.
      </p>
      ...
      <div className="mt-6 md:mx-20 text-center">
        ...
        <div className='flex mb-5 items-center justify-center'>
          <Link
            href="#"
            onClick={() => window.open('/HackathonProblemStatement.pdf', '_blank')}
