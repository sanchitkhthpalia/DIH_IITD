...
const IdealSponsorComponent = () => {
  ...
  return (
    <div id='idealsponsor' className="mx-auto px-4 py-8" ref={ref}>
      ...
      <motion.h1
        className="text-4xl lg:text-6xl lg:px-32 font-bold mb-20 text-center"
      ...
      {/* Card Section */}
      <div 
        className="grid grid-cols-1 bg-[#007F40] md:grid-cols-4 gap-6"
        style={{
      ...
      >
        ...
        {[
          ...
          <motion.div
            key={index}
            className="py-10 px-6 flex flex-col items-center text-center hover:bg-[#5D7BA1] text-white transition-transform duration-200 rounded-sm ease-in-out transform hover:scale-105"
