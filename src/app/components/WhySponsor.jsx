...
function WhySponsor() {
  ...
  return (
    ...
    >
      {/* Title */}
      <motion.h2
        className="text-4xl sm:text-4xl lg:text-6xl font-bold mb-20"
      ...
      <motion.div className="space-y-6 text-lg sm:text-lg md:text-xl leading-relaxed text-justify">
        ...
        >
          ...
          Indian student community. Hack-a-thons and incubators provide these entrepreneurs the much
        ...
        <motion.p
          ...
          viewport={{ once: true, amount: 0.2 }}
        >
          The Hack-a-thon allows sponsors to exhibit awesome products and ideas that can be used to aid
