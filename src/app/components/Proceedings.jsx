...
export default function Proceedings() {
  ...
  return (
    <div className="w-full mx-auto px-4 lg:px-32 py-12" ref={ref}>
      {/* Title */}
      <motion.h1
        className="text-4xl sm:text-4xl lg:text-6xl font-bold text-center mb-8 md:mb-16 lg:mb-20"
        initial="hidden"
        animate={inView ? "visible" : "hidden"}
        variants={fadeInVariant}
        transition={{ duration: 0.5 }}
      >
        OUR PREVIOUS HACK-A-THON
      </motion.h1>
      ...
      <div className="space-y-6 text-justify leading-relaxed  text-lg sm:text-lg lg:text-xl">
        ...
        >
          Guest speaker provided valuable insights into digital entrepreneurship and industry collaboration. The Hack-a-thon then kicked off with intensive ideation, business model discussions, and pitching to mentors. A night coding session (10 PM to 11 AM) saw participants building their prototypes.
        </motion.p>
